...
<head>
	...
	<script >
		...
		function pageChange(pageNum) {
			window.location.href="${pageContext.request.contextPath}/user/getUserByPage.do?page"
		}
				...
				<li style="padding-top:8px;">
					<div class="btn-group">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li class="divider"></li>
							<li><a href="index2.jsp"><i class="glyphicon glyphicon-off"></i> 退出系统</a></li>
						</ul>
					</div>
				</li>
							...
							<tr >
								<td colspan="6" align="center">
									<ul class="pagination">
										...
										<c:if test="${pageInfo.pageNum!=1}">
											<li class="disabled"><a href="#" onclick="pageChange(${pageInfo.pageNum-1})">上一页</a> </li>
										</c:if>
