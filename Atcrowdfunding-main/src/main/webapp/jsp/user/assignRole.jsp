                ...
                <div class="panel-body">
                    <form role="form" class="form-inline">
                        <div class="form-group">
                            ...
                            <select id="leftRoleList" class="form-control" multiple size="10" style="width:150px;overflow-y:auto;">
                        ...
                        <div class="form-group" style="margin-left:40px;">
                            ...
                            <select id="rightRoleList" class="form-control" multiple size="10" style="width:150px;overflow-y:auto;">
...
<script>
    ...
    $("#leftToRightBtn").click(function () {
        var leftOptions = $("#leftRoleList option:selected");
        ...
        $.ajax({
            type:"POST",
            url:"${pageContext.request.contextPath}/user/doAssignRole.do",
            data:jsonObj,
            success:function (result) {
                if (result.success) {
                    $("#rightRoleList").append(leftOptions.clone());
                    leftOptions.remove();
                }else {
    ...
    $("#rightToLeftBtn").click(function () {
        var rightOptions = $("#rightRoleList option:selected");
        var jsonObj={
            "userid":${param.id}
        };
        $.each(rightOptions,function (i,n) {
            jsonObj["ids["+i+"]"]=this.value;
        ...
        $.ajax({
            type:"POST",
            url:"${pageContext.request.contextPath}/user/undoAssignRole.do",
            data:jsonObj,
            success:function (result) {
                if (result.success) {
                    $("#leftRoleList").append(rightOptions.clone());
                    rightOptions.remove();
                }else {
                    alert(result.message);
                }
