				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<button type="button" class="btn btn-primary"
							style="float: right;" onclick="window.location.href='${pageContext.request.contextPath}/advert/add.htm'">
	...
	<script type="text/javascript">
            ...
            function queryPage( pageno ){
            	...
            	$.ajax({
            		...
            		url : "${pageContext.request.contextPath}/advert/pageQuery.do",
            		type : "post",
            		data : dataObj,
            		beforeSend : function(){
            		...
            		success : function(result){
            			...
            			if(result.success){
            				...
            				$.each(list,function(i,n){
								...
								content+="	<td>";
								content+="		<button type='button' onclick='window.location.href=\"${pageContext.request.contextPath}/advert/edit.htm?pageno="+pageObj.pageNum+"&id="+n.id+"\"' class='btn btn-primary btn-xs'>";
							...
							if ( pageObj.pageNum != 1 ) {
								pageContent = pageContent + '<li><a href="#" onclick="changePageno('+(pageObj.pageNum-1)+')">上一页</a></li>';
							}
							...
							if ( pageObj.pageNum != pageObj.pages ) {
								pageContent = pageContent + '<li><a href="#" onclick="changePageno('+(pageObj.pageNum+1)+')">下一页</a></li>';
							}
            ...
            function deleteAdvert(id,name){
    			...
    			layer.confirm("是否要删除广告?",  {icon: 3, title:'提示'}, function(cindex){
    				...
    				$.ajax({
    					url : "${pageContext.request.contextPath}/advert/delete.do",
    					type : "POST",
    					data : {id:id},
    					success : function(result){
    						if(result.success){
            ...
            $("#batchDelete").click(function(){
            	...
            	if(checkedList.length>0){
            		layer.confirm("确定要删除吗?",  {icon: 3, title:'提示'}, function(cindex){
            			...
            			$.ajax({
            				url : "${pageContext.request.contextPath}/advert/batchDelete.do",
            				type : "POST",
            				data : datas ,
            				success : function(result){
            					if(result.success){
