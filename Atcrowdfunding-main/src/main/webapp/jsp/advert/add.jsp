        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="panel panel-default">
			  ...
			  <div class="panel-body">
				<form id="from" method="post" action="" enctype="multipart/form-data">
        ...
        <script type="text/javascript">
            ...
            $(function(){
            	$("#saveBtn").click(function(){
            		var options = {
            			url:"${pageContext.request.contextPath}/advert/doAdd.do",
           				...
           				success : function(result){
                			...
                			if(result.success){
                				...
                				window.location.href="${pageContext.request.contextPath}/advert/index.htm";
                			}else{
            		...
            		$("#from").ajaxSubmit(options); //异步提交
            		return ;


            		/* $("#advertForm").attr("action","${pageContext.request.contextPath}/advert/doAdd.do");
            		$("#advertForm").submit(); */
