			  ...
			  <div class="panel-body">
				<form id="updateForm">
				  ...
				  <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="url">广告状态</label>
                        <input type="text" class="form-control" id="status" value="${advert.status }" placeholder="请输入广告地址">
                        <p class="help-block label label-warning">请输入合法的广告状态,格式为：0 -草稿 1-未审核 2-审核完成</p>
                    </div>
            ...
            $(function(){
            	$("#updateBtn").click(function(){
                	...
                	$.ajax({
                		...
                		url : "${pageContext.request.contextPath}/advert/update.do",
                		type : "POST",
                		data : {
                			name : $("#name").val(),
                			url : $("#url").val(),
                		...
                		success : function(result){
                			...
                			if(result.success){
                				...
                				window.location.href="${pageContext.request.contextPath}/advert/index.htm?pageno=${param.pageno}";
                			}else{
